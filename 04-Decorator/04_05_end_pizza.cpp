...
int main()
{
    ...
    auto margheritaWithMushrooms = make_unique<MushroomDecorator>(std::move(margheritaPizza));
    auto margheritaExtraCheeseMushrooms = make_unique<ExtraCheeseDecorator>(std::move(margheritaWithMushrooms));
    ...
    auto pepperoniWithMushrooms = make_unique<MushroomDecorator>(std::move(pepperoniPizza));
    auto pepperoniWithTomatoMushrooms = make_unique<TomatoDecorator>(std::move(pepperoniWithMushrooms));
    auto pepperoniTomatoMushroomsExtraCheese = make_unique<ExtraCheeseDecorator>(std::move(pepperoniWithTomatoMushrooms));
